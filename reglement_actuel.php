...
$erreur = false;
$message = "";
if ($CS_TCBR + $TM_TCBR < 54) {
    $erreur = true;
    $message .= "CS+TM TCBR inférieur à 54.<br>";
}
if ($CS_FCBR + $TM_FCBR < 30) {
    $erreur = true;
    $message .= "CS+TM FCBR inférieur à 30.<br>";
}
if ($CS_TCBR + $CS_FCBR < 30) {
    $erreur = true;
    $message .= "CS BR inférieur à 30.<br>";
}
if ($TM_TCBR + $TM_FCBR < 30) {
    $erreur = true;
    $message .= "TM BR inférieur à 30.<br>";
}
if ($ST_TCBR < 30) {
    $erreur = true;
    ...
    <div class="forceSize" style="text-align: center">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <a href="index.php" class="btn btn-lg btn-default">Liste cursus</a>
            </div>
        </div>
    </div>
